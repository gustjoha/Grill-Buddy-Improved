!function (e) {
  ...
  function n(e, t, r) {
    if (r || 2 === arguments.length) for (var i, s = 0, n = t.length; s < n; s++) !i && s in t || (i || (i = Array.prototype.slice.call(t, 0, s)), i[s] = t[s]);
  ...
  class c {
    ...
    get styleSheet() {
      ...
      if (a && void 0 === e) {
        ...
        r && (e = h.get(t)), void 0 === e && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), r && h.set(t, e));
      }
      return e;
    }
    toString() {
  ...
  class A extends HTMLElement {
    ...
    static finalizeStyles(e) {
      ...
      if (Array.isArray(e)) {
        ...
        for (const e of r) t.unshift(p(e));
    ...
    _$EO(e, t, r = y) {
      ...
      if (void 0 !== s && !0 === r.reflect) {
        const n = (void 0 !== (null === (i = r.converter) || void 0 === i ? void 0 : i.toAttribute) ? r.converter : _).toAttribute(t, r.type);
    ...
    _$AK(e, t) {
      ...
      if (void 0 !== s && this._$El !== s) {
        const e = i.getPropertyOptions(s),
          ...
          } : void 0 !== (null === (r = e.converter) || void 0 === r ? void 0 : r.fromAttribute) ? e.converter : _;
    ...
    performUpdate() {
      ...
      const r = this._$AL;
      try {
        t = this.shouldUpdate(r), t ? (this.willUpdate(r), null === (e = this._$ES) || void 0 === e || e.forEach(e => {
          var t;
  ...
  /**
       ...
       */
  var w;
  A[E] = !0, A.elementProperties = new Map(), A.elementStyles = [], A.shadowRootOptions = {
    mode: "open"
  }, null == g || g({
    ReactiveElement: A
  ...
  const H = window,
    ...
    K = new WeakMap(),
    X = C.createTreeWalker(C, 129, null, !1);
  function W(e, t) {
  ...
  const Z = (e, t) => {
    ...
    for (let a = 0; a < r; a++) {
      ...
      let r,
        ...
        h = -1,
        c = 0;
      for (; c < t.length && (o.lastIndex = c, l = o.exec(t), null !== l);) c = o.lastIndex, o === x ? "!--" === l[1] ? o = M : void 0 !== l[1] ? o = U : void 0 !== l[2] ? (j.test(l[2]) && (s = RegExp("</" + l[2], "g")), o = k) : void 0 !== l[3] && (o = k) : o === k ? ">" === l[0] ? (o = null != s ? s : x, h = -1) : void 0 === l[1] ? h = -2 : (h = o.lastIndex - l[2].length, r = l[1], o = void 0 === l[3] ? k : '"' === l[3] ? D : G) : o === D || o === G ? o = k : o === M || o === U ? o = x : (o = k, s = void 0);
  ...
  class Y {
    constructor({
      ...
      const o = e.length - 1,
        a = this.parts,
        [l, h] = Z(e, t);
      if (this.el = Y.createElement(l, r), X.currentNode = this.el.content, 2 === t) {
        const e = this.el.content,
          t = e.firstChild;
        t.remove(), e.append(...t.childNodes);
      }
      for (; null !== (i = X.nextNode()) && a.length < o;) {
        if (1 === i.nodeType) {
          if (i.hasAttributes()) {
            const e = [];
  ...
  function q(e, t, r = e, i) {
    var s, n, o, a;
    if (t === V) return t;
    let l = void 0 !== i ? null === (s = r._$Co) || void 0 === s ? void 0 : s[i] : r._$Cl;
    const h = N(t) ? void 0 : t._$litDirective$;
    return (null == l ? void 0 : l.constructor) !== h && (null === (n = null == l ? void 0 : l._$AO) || void 0 === n || n.call(l, !1), void 0 === h ? l = void 0 : (l = new h(e), l._$AT(e, r, i)), void 0 !== i ? (null !== (o = (a = r)._$Co) && void 0 !== o ? o : a._$Co = [])[i] = l : r._$Cl = l), void 0 !== l && (t = q(e, l._$AS(e, t.values), l, i)), t;
  }
  class Q {
    constructor(e, t) {
    ...
    u(e) {
      ...
      const {
        ...
        s = (null !== (t = null == e ? void 0 : e.creationScope) && void 0 !== t ? t : C).importNode(r, !0);
      X.currentNode = s;
      let n = X.nextNode(),
        o = 0,
        a = 0,
      ...
      for (; void 0 !== l;) {
        if (o === l.index) {
          let t;
          2 === l.type ? t = new J(n, n.nextSibling, this, e) : 1 === l.type ? t = new l.ctor(n, l.name, l.strings, this, e) : 6 === l.type && (t = new ne(n, this, e)), this._$AV.push(t), l = i[++a];
        }
        o !== (null == l ? void 0 : l.index) && (n = X.nextNode(), o++);
      }
  ...
  class J {
    constructor(e, t, r, i) {
      var s;
      this.type = 2, this._$AH = z, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = r, this.options = i, this._$Cp = null === (s = null == i ? void 0 : i.isConnected) || void 0 === s || s;
    }
    get _$AU() {
      var e, t;
    ...
    _$AI(e, t = this) {
      e = q(this, e, t), N(e) ? e === z || null == e || "" === e ? (this._$AH !== z && this._$AR(), this._$AH = z) : e !== this._$AH && e !== V && this._(e) : void 0 !== e._$litType$ ? this.g(e) : void 0 !== e.nodeType ? this.$(e) : (e => I(e) || "function" == typeof (null == e ? void 0 : e[Symbol.iterator]))(e) ? this.T(e) : this._(e);
    }
    k(e) {
    ...
    _(e) {
      this._$AH !== z && N(this._$AH) ? this._$AA.nextSibling.data = e : this.$(C.createTextNode(e)), this._$AH = e;
    }
    g(e) {
      var t;
      const {
        ...
        s = "number" == typeof i ? this._$AC(e) : (void 0 === i.el && (i.el = Y.createElement(W(i.h, i.h[0]), this.options)), i);
      if ((null === (t = this._$AH) || void 0 === t ? void 0 : t._$AD) === s) this._$AH.v(r);else {
    ...
    _$AC(e) {
      ...
      return void 0 === t && K.set(e.strings, t = new Y(e)), t;
    }
    T(e) {
      ...
      let r,
        i = 0;
      for (const s of e) i === t.length ? t.push(r = new J(this.k(O()), this.k(O()), this, this.options)) : r = t[i], r._$AI(s), i++;
  ...
  class ee {
    constructor(e, t, r, i, s) {
      this.type = 1, this._$AH = z, this._$AN = void 0, this.element = e, this.name = t, this._$AM = i, this.options = s, r.length > 2 || "" !== r[0] || "" !== r[1] ? (this._$AH = Array(r.length - 1).fill(new String()), this.strings = r) : this._$AH = z;
    }
    get tagName() {
    ...
    _$AI(e, t = this, r, i) {
      ...
      let n = !1;
      if (void 0 === s) e = q(this, e, t, 0), n = !N(e) || e !== this._$AH && e !== V, n && (this._$AH = e);else {
        const i = e;
        let o, a;
        for (e = s[0], o = 0; o < s.length - 1; o++) a = q(this, i[r + o], t, o), a === V && (a = this._$AH[o]), n || (n = !N(a) || a !== this._$AH[o]), a === z ? e = z : e !== z && (e += (null != a ? a : "") + s[o + 1]), this._$AH[o] = a;
      }
      n && !i && this.j(e);
    }
    j(e) {
  ...
  class ie extends ee {
    ...
    j(e) {
      e && e !== z ? this.element.setAttribute(this.name, re) : this.element.removeAttribute(this.name);
    }
  }
  class se extends ee {
    constructor(e, t, r, i, s) {
    ...
    _$AI(e, t = this) {
      var r;
      if ((e = null !== (r = q(this, e, t, 0)) && void 0 !== r ? r : z) === V) return;
      const i = this._$AH,
        s = e === z && i !== z || e.capture !== i.capture || e.once !== i.once || e.passive !== i.passive,
        n = e !== z && (i === z || s);
  ...
  class he extends A {
    ...
    update(e) {
      const t = this.render();
      this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = ((e, t, r) => {
        var i, s;
        const n = null !== (i = null == r ? void 0 : r.renderBefore) && void 0 !== i ? i : t;
        let o = n._$litPart$;
        if (void 0 === o) {
          const e = null !== (s = null == r ? void 0 : r.renderBefore) && void 0 !== s ? s : null;
          n._$litPart$ = o = new J(t.insertBefore(O(), e), e, void 0, null != r ? r : {});
        }
        return o._$AI(e), o;
  ...
  function me(e) {
    return (t, r) => void 0 !== r ? de(e, t, r) : pe(e, t);
    /**
         * @license
         * Copyright 2017 Google LLC
         * SPDX-License-Identifier: BSD-3-Clause
  ...
  function be(e, t) {
    return (({
      ...
      var s;
      if (void 0 === i) {
        const i = null !== (s = r.originalKey) && void 0 !== s ? s : r.key,
          n = null != t ? {
            kind: "method",
            placement: "prototype",
            key: i,
      ...
      }
      {
        ...
        void 0 !== t && Object.defineProperty(r, i, t(i)), null == e || e(s, i);
      }
    })({
      descriptor: r => {
        const i = {
  ...
  var ve = function (e, t, r, i) {
    ...
    return s.detail = r, e.dispatchEvent(s), s;
  };
  let ye = !1,
    Ee = null;
  const Ae = async () => {
      if (!ye) {
        if (Ee) return Ee;
        if (!(customElements.get("ha-checkbox") && customElements.get("ha-slider") && customElements.get("ha-panel-config"))) return Ee = (async () => {
          try {
            ...
            await t.routerOptions.routes.automation.load(), ye = !0;
          } catch (e) {
            throw Ee = null, e;
          }
        })(), Ee;
...
`;
  let ze = class extends De(he) {
    ...
    async _fetchData() {
      this.hass && (this.config = await Me(this.hass), this.data = this.config);
    }
    firstUpdated() {
      (async () => {
        await Ae();
    ...
    render() {
      return this.hass && this.config && this.data ? F`<h1>Barf</h1>` : F``;
    }
    saveData(e) {
      var t, r;
      this.hass && this.data && (this.data = Object.assign(Object.assign({}, this.data), e), (t = this.hass, r = this.data, t.callApi("POST", we + "/config", r)).catch(e => je(e, this.shadowRoot.querySelector("ha-card"))).then());
    }
    toggleInformation(e) {
      var t;
      const r = null === (t = this.shadowRoot) || void 0 === t ? void 0 : t.querySelector("#" + e);
  ...
  var Ye,
    ...
    rt = {
      presets: {
        ...
        beef_medium: "Beef (medium)",
        beef_medium_well: "Beef (medium well)",
        beef_well_done: "Beef (well done)",
        fish: "Fish",
        ground_beef: "Ground Beef",
        ground_poultry: "Ground Poultry",
        lamb_rare: "Lamb (rare)",
        lamb_medium_rare: "Lamb (medium rare)",
        lamb_medium: "Lamb (medium)",
        lamb_medium_well: "Lamb (medium well)",
        lamb_well_done: "Lamb (well done)",
        pork_medium: "Pork (medium)",
        pork_medium_well: "Pork (medium well)",
        pork_well_done: "Pork (well done)",
        poultry: "Poultry",
        turkey: "Turkey",
        veal_rare: "Veal (rare)",
        veal_medium_rare: "Veal (medium rare)",
        veal_medium: "Veal (medium)",
        veal_medium_well: "Veal (medium well)",
    ...
    at = {
      probes: {
        ...
        errors: {
          ...
          source_does_not_exist: "De bron bestaat niet. Vul een bestaande bron in, zoals bijvoorbeeld 'sensor.mysensor'."
        },
        cards: {
          "add-probe": {
            header: "Voeg thermometer toe",
            actions: {
              add: "Voeg toe"
            }
          }
    ...
    ht = {
      presets: {
        ...
        beef_medium: "Rundvlees (medium)",
        beef_medium_well: "Rundvlees (medium well)",
        beef_well_done: "Rundvlees (well done)",
        fish: "Vis",
        ground_beef: "Rundvleesgehakt",
        ground_poultry: "Gevogeltegehakt",
        lamb_rare: "Lamsvlees (rare)",
        lamb_medium_rare: "Lamvlees (medium rare)",
        lamb_medium: "Lamsvlees (medium)",
        lamb_medium_well: "Lamsvlees (medium well)",
        lamb_well_done: "Lamsvlees (well done)",
        pork_medium: "Varkensvlees (medium)",
        pork_medium_well: "Varkensvlees (medium well)",
        pork_well_done: "Varkensvlees (well done)",
        poultry: "Gevogelte",
        turkey: "Kalkoen",
        veal_rare: "Kalfsvlees (rare)",
        veal_medium_rare: "Kalfsvlees (medium rare)",
        veal_medium: "Kalfsvlees (medium)",
        veal_medium_well: "Kalfsvlees (medium well)",
    ...
    mt = {
      probes: {
        ...
        labels: {
          ...
          state_update_setting: "Ziel",
          upper_bound: "Obere Schwelle",
          lower_bound: "Untere Schwelle",
      ...
      help: {
        ...
        cards: {
          "how-to-get-help": {
            title: "Wie man Hilfe bekommt",
            "first-read-the": "Lies zuerst die",
            readme: "Readme",
            "if-you-still-need-help": "Wenn du weiterhin Hilfe brauchst, kontaktiere das",
            "community-forum": "Community-Forum",
            "or-open-a": "oder öffne ein",
            "github-issue": "Github-Issue",
            "english-only": "Nur auf Englisch bitte"
          }
        }
      }
    },
    ...
    ft = {
      presets: {
        ...
        beef_medium: "Rind (medium)",
        beef_medium_well: "Rind (medium well)",
        beef_well_done: "Rind (well done)",
        fish: "Fisch",
        ground_beef: "Hackfleisch (Rind)",
        ground_poultry: "Hackfleisch (Geflügel)",
        lamb_rare: "Lamm (blutig)",
        lamb_medium_rare: "Lamm (medium rare)",
        lamb_medium: "Lamm (medium)",
        lamb_medium_well: "Lamm (medium well)",
        lamb_well_done: "Lamm (well done)",
        pork_medium: "Schwein (medium)",
        pork_medium_well: "Schwein (medium well)",
        pork_well_done: "Schwein (well done)",
        poultry: "Geflügel",
        turkey: "Truthahn",
        veal_rare: "Kalb (blutig)",
        veal_medium_rare: "Kalb (medium rare)",
        veal_medium: "Kalb (medium)",
        veal_medium_well: "Kalb (medium well)",
    ...
    return e.prototype.parse = function () {
      ...
      return {
        val: {
          ...
          tokens: r,
          location: t,
          parsedOptions: this.shouldParseSkeletons ? Ft(r) : {}
        },
        err: null
      };
  ...
  function jr(e, t, ...r) {
    ...
    let s;
    try {
      s = e.split(".").reduce((e, t) => e[t], Dr[i]);
    } catch (We) {
      s = e.split(".").reduce((e, t) => e[t], Dr.en);
    }
    if (void 0 === s && (s = e.split(".").reduce((e, t) => e[t], Dr.en)), !r.length) return s;
    const n = {};
    for (let a = 0; a < r.length; a += 2) {
      let e = r[a];
      e = e.replace(/^{([^}]+)?}$/, "$1"), n[e] = r[a + 1];
    }
    try {
      return new Gr(s, t).format(n);
    } catch (o) {
      return "Translation " + o;
    }
  }
  let Fr = class extends De(he) {
    constructor() {
    ...
    hassSubscribe() {
      return this.config && this.probes.length || this._fetchData(), [this.hass.connection.subscribeMessage(() => this._fetchData(), {
        type: we + "_config_updated"
      })];
    }
    async _fetchData() {
    ...
    handleAddProbe() {
      const e = {
        probe_id: this.probes.length,
        probe_name: this.nameInput.value,
        probe_source: this.sourceInput.value,
        probe_source_type: Ce,
        probe_preset: void 0
      };
      this.probes = [...this.probes, e], this._renderCache.clear(), this._lastProbesHash = "", this.saveToHA(e);
    }
    handleEditProbe(e, t) {
      this.hass && (this.probes = Object.values(this.probes).map((r, i) => i === e ? t : r), this._renderCache.clear(), this._lastProbesHash = "", this.saveToHA(t));
    }
    handleRemoveProbe(e, t) {
      if (!this.hass) return;
    ...
    saveToHA(e) {
      var t, r;
      this.hass && (e.probe_source in this.hass.states ? (t = this.hass, r = e, delete Ie.probes, delete Ie["initial-data"], t.callApi("POST", we + "/probes", r)) : je({
        body: {
          message: jr("panels.probes.errors.source_does_not_exist", this.hass.language)
        },
        error: jr("panels.probes.errors.invalid_source", this.hass.language)
      }, this.shadowRoot.querySelector("ha-card")));
    }
    renderTheOptions(e, t) {
      if (this.hass) {
        let r = F`<option value="" ?selected=${void 0 === t}">---${jr("common.labels.select", this.hass.language)}---</option>`;
        return Object.entries(e).map(([e, i]) => r = F`${r}
            <option
              value="${i.preset_id}"
    ...
    renderProbe(e, t) {
        ...
        return r = i ? F`
          <div class="probeline">
            <label for="probe_preset${t}"
              >${jr("panels.probes.labels.preset", this.hass.language)}:</label
            >
            <select
              id="probe_preset${t}"
              @change="${r => this.handleEditProbe(t, Object.assign(Object.assign({}, e), {
          [Te]: parseInt(r.target.value)
        }))}"
            >
        ...
        ` : F`
          <div class="probeline">
            <label for="probe_target_temperature${t}"
              >${jr("panels.probes.labels.value", this.hass.language)}:</label
            >
            <input
              text="text"
        ...
        <ha-card header="${e.probe_name}">
          ...
          <div class="card-content">
            <label for="probe_name${t}"
              >${jr("panels.probes.labels.name", this.hass.language)}:</label
            >
            <input
              id="probe_name${t}"
              type="text"
          ...
          [He]: r.target.value
            ...
            <div class="probeline">
              <label for="probe_source${t}"
                >${jr("panels.probes.labels.source", this.hass.language)}:</label
              >
          ...
          [$e]: r.target.value
            ...
            <div class="probeline">
            <label for="probe_source_type${t}">${jr("panels.probes.labels.sourcetype", this.hass.language)}:</label>
          ...
          [Le]: r.target.value
              ...
              <label for="probe_source_type_preset${t}">${jr("panels.probes.labels.sourcetypes.preset", this.hass.language)}</label>
              <input type="radio" id="probe_source_type_value${t}" value="${"source_type_value"}" name="probe_source_type${t}"
              ?checked="${!i}" @change="${r => this.handleEditProbe(t, Object.assign(Object.assign({}, e), {
          [Le]: r.target.value
        }))}"/><label for="probe_source_type_value${t}">${jr("panels.probes.labels.sourcetypes.value", this.hass.language)}</label>
            </div>${r}
            <div class="probeline">
      <label for="probe_lower_bound${t}">${jr("panels.probes.labels.lower_bound", this.hass.language)}:</label><input id="probe_lower_bound${t}" class="shortinput" type = "text"
      ...
      <div class="probeline">
      <label for="probe_upper_bound${t}">${jr("panels.probes.labels.upper_bound", this.hass.language)}:</label>
...
<div class="probeline">
            <label for="probe_state_update_setting${t}">${jr("panels.probes.labels.state_update_setting", this.hass.language)}:</label>
            <select
          ...
          >
            ...
            <svg
              ...
              >
                <title>
                  ${jr("common.actions.delete", this.hass.language)}
                </title>
    ...
    _generateProbesHash() {
      return JSON.stringify(this.probes.map(e => ({
        id: e.probe_id,
        name: e.probe_name,
    ...
    _renderProbesMemoized() {
      const e = this._generateProbesHash();
      if (e === this._lastProbesHash && this._renderCache.has("probes")) return this._renderCache.get("probes") || [];
      const t = Object.entries(this.probes).map(([e, t]) => this.renderProbe(t, parseInt(e)));
      return this._renderCache.set("probes", t), this._lastProbesHash = e, t;
    }
    render() {
      return this.hass && this.config ? F`
        <ha-card
          header="${jr("panels.probes.title", this.hass.language)}"
        >
          <div class="card-content">
            ${jr("panels.probes.description", this.hass.language)}
          </div>
        </ha-card>
        <ha-card
          header="${jr("panels.probes.cards.add-probe.header", this.hass.language)}"
        >
          <div class="card-content">
            <div class="probeline">
              <label for="nameInput"
            ...
            <div class="probeline">
              <button @click="${this.handleAddProbe}">
                ${jr("panels.probes.cards.add-probe.actions.add", this.hass.language)}
              </button>
            </div>
          </div>
        </ha-card>
  ...
  s([me()], Fr.prototype, "config", void 0), s([me({
    type: Array
  })], Fr.prototype, "probes", void 0), s([me({
    type: Array
  })], Fr.prototype, "presets", void 0), s([me({
    type: Array
  })], Fr.prototype, "state_update_settings", void 0), s([me({
    type: Array
  })], Fr.prototype, "sensors", void 0), s([be("#nameInput")], Fr.prototype, "nameInput", void 0), s([be("#sourceInput")], Fr.prototype, "sourceInput", void 0), Fr = s([ue("grill-buddy-view-probes")], Fr);
  const Vr = () => {
    const e = e => {
        let t = {};
        for (let r = 0; r < e.length; r += 2) {
          const i = e[r],
            s = r < e.length ? e[r + 1] : void 0;
    ...
    if (t.length > 3) {
      ...
      if (t.includes("filter")) {
        const t = i.findIndex(e => "filter" == e),
          s = i.slice(t + 1);
        i = i.slice(0, t), r = Object.assign(Object.assign({}, r), {
          filter: e(s)
        });
      }
      i.length && (i.length % 2 && (r = Object.assign(Object.assign({}, r), {
        subpage: i.shift()
      })), i.length && (r = Object.assign(Object.assign({}, r), {
        params: e(i)
      })));
    }
    return r;
  ...
  e.GrillBuddyPanel = class extends he {
    constructor() {
      super(...arguments), this._isInitialized = !1, this._haElementsLoaded = !1;
    }
    async firstUpdated() {
      this._isInitialized || (window.addEventListener("location-changed", () => {
        window.location.pathname.includes("grill-buddy") && this.requestUpdate();
      }), this._isInitialized = !0), this._haElementsLoaded || Ae().then(() => {
        this._haElementsLoaded = !0, this.requestUpdate();
      }).catch(e => {});
    }
    render() {
      if (!this._haElementsLoaded) return F` <div>Loading Grill Buddy...</div> `;
      const e = Vr();
      return F`
      <div class="header">
        <div class="toolbar">
          <ha-menu-button
            ...
            .narrow=${this.narrow}
          ></ha-menu-button>
          <div class="main-title">${jr("title", this.hass.language)}</div>
        ...
        >
          <sl-tab slot="nav" panel="probes" .active=${"probes" === e.page}>
            ${jr("panels.probes.title", this.hass.language)}
          </sl-tab>
          <sl-tab slot="nav" panel="help" .active=${"help" === e.page}
            >${jr("panels.help.title", this.hass.language)}</sl-tab
          >
        </sl-tab-group>
      </div>
    ...
    getView(e) {
      switch (e.page) {
        ...
        case "help":
          return F`<ha-card
          header="${jr("panels.help.cards.how-to-get-help.title", this.hass.language)}"
        >
          <div class="card-content">
            ${jr("panels.help.cards.how-to-get-help.first-read-the", this.hass.language)}
            <a href="https://github.com/jeroenterheerdt/grillbuddy/"
              >${jr("panels.help.cards.how-to-get-help.readme", this.hass.language)}</a
            >.
            ${jr("panels.help.cards.how-to-get-help.if-you-still-need-help", this.hass.language)}
            <a
              href="https://community.home-assistant.io/t/grill-buddy-your-grilling-companion"
              >${jr("panels.help.cards.how-to-get-help.community-forum", this.hass.language)}</a
            >
            ${jr("panels.help.cards.how-to-get-help.or-open-a", this.hass.language)}
            <a href="https://github.com/jeroenterheerdt/grillbuddy/issues"
              >${jr("panels.help.cards.how-to-get-help.github-issue", this.hass.language)}</a
            >
            (${jr("panels.help.cards.how-to-get-help.english-only", this.hass.language)}).
          </div></ha-card
        >`;
        default:
          return F`
    ...
    handlePageSelected(e) {
      ...
      t !== Vr().page ? (!function (e, t, r) {
        ...
        t.forEach(e => {
          "string" == typeof e ? r = Object.assign(Object.assign({}, r), {
            subpage: e
          }) : "params" in e ? r = Object.assign(Object.assign({}, r), {
            params: e.params
          }) : "filter" in e && (r = Object.assign(Object.assign({}, r), {
            filter: e.filter
          }));
        });
        const i = e => {
          ...
          return t.forEach(t => {
            const i = e[t];
            r = r.length ? `${r}/${t}/${i}` : `${t}/${i}`;
          }), r;
        };
        let s = `/${we}/${r.page}`;
        return r.subpage && (s = `${s}/${r.subpage}`), i(r.params).length && (s = `${s}/${i(r.params)}`), r.filter && (s = `${s}/filter/${i(r.filter)}`), s;

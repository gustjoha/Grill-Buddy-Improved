...
`;
  let We = class extends Ve(he) {
    ...
    render() {
      return this.hass && this.config && this.data ? j`<h1>Barf</h1>` : j``;
    }
    saveData(e) {
      var t, r;
...
<div class="probeline">
  ...
  const qr = () => {
    ...
    if (r.length > 3) {
      let e = r.slice(3);
      const s = e.indexOf("filter");
      if (-1 !== s) {
        const r = e.slice(s + 1);
        e = e.slice(0, s), i.filter = t(r);
      }
